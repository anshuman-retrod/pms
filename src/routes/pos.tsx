...
import { canAccessPlatformApp, getPlatformApp, resolvePlatformApps } from "@/features/retrod-one/lib/access";
...
function PosRouteComponent() {
  ...
  if (
    !posApp ||
    !canAccessPlatformApp(user?.role, resolvePlatformApps(entitlements), posApp)
  ) {
    return (
      <FeatureDisabled
