...
const selectCls = "h-9 rounded-md border border-border bg-surface px-2 text-[13px] text-text-primary focus:border-primary focus:outline-none";
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="font-medium text-text-primary">
                          {u.name}
                          {currentUser?.id === u.id && <span className="ml-2 text-[10px] text-primary">you</span>}
                        </div>
